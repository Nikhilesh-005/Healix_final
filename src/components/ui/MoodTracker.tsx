...
const MoodTracker: React.FC<MoodTrackerProps> = ({ imageUrl, email, userId }) => {
  ...
  return (
    <div className="w-95 h-full relative rounded-xl p-4 flex flex-col items-center overflow-hidden bg-[#1a1a1a]">
      {/* Animated Dark Gradient Background (matches CalmLoadingScreen) */}
      <motion.div
