...
import { LayoutDashboard, Bot, Users, Calendar, BrainCircuit, History } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  const links = [
    ...
    {
      label: "History",
      href: "/dashboard/personal-assist?view=history",
      icon: <History className="h-6 w-6 flex-shrink-0" />,
    },
  ];
